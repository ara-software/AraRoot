...
#define THRESHOLDS_PER_ATRI 16 //TDA_PER_ATRI*ANTS_PER_TDA
#define SAMPLES_PER_BLOCK 64
#define MAX_TRIG_BLOCKS 4
#define CHANNELS_PER_ATRI 32 //DDA_PER_ATRI*RFCHAN_PER_DDA
#define SAMPLES_PER_DDA 32768 //SAMPLES_PER_BLOCK*BLOCKS_PER_DDA
