...
void AraSunPos::sunpos(AraSunPosTime udtTime, AraSunPosLocation udtLocation, AraSunPosSunCoordinates *udtSunCoordinates){
  ...
  // Calculate local coordinates ( azimuth and zenith angle ) in degrees
  {
    ...
    dLocalMeanSiderealTime = (dGreenwichMeanSiderealTime*15 
			      + udtLocation.dLongitude)*TMath::DegToRad();
    dHourAngle = dLocalMeanSiderealTime - dRightAscension;
    dLatitudeInRadians = udtLocation.dLatitude*TMath::DegToRad();
    ...
    if ( udtSunCoordinates->dAzimuth < 0.0 ) 
      udtSunCoordinates->dAzimuth = udtSunCoordinates->dAzimuth + TMath::TwoPi();
    udtSunCoordinates->dAzimuth = udtSunCoordinates->dAzimuth/TMath::DegToRad();
    // Parallax Correction
